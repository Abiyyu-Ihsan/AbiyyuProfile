    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">I'M Abiyyu Ihsan</h1>
      ...
      <v-col cols="12" class="mt-16" id="about">
        <div>
          <v-row>
            <v-col cols="12" sm="6">
              <div class="egg">
                <v-img src="i1.png" max-height="300" class=""></v-img>
              </div>
            </v-col>
            <v-col cols="12" sm="6">
              ...
              <h4 class="mt-n4">I Am a Student</h4>
           
              <p class="text-grey">
                Hello, Saya merupakan mahasiswa semester 5 di Jakarta Global University yang suka dengan tantangan. Saya selama ini sudah mempelajari dasar-dasar dari JavaScript, React, PHP, dan MySQL.
              </p>
            ...
            <v-col cols="12">
              ...
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">UI/UX Designer</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" variant="tonal">UI/UX</v-btn>
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              ></v-btn
              ><br />
              <span class="text-caption">Cipayung, Jakarta Timur, DKI Jakarta </span
              ><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">0813-8638-7821 </span> <br />
              ...
              ></v-btn
              ><br />
              <span class="text-caption">abiyyuihsan@gmail.com </span> <br />
              <span class="text-caption">abiyyuihsan07@gmail.com </span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
